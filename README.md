...
[![Coverage](https://img.shields.io/badge/Coverage-82%25%20(97%2F97%20passed)-brightgreen.svg)](#)
...
pytest tests/unit/ -v
```
> **97 passed in ~45s** (82% test coverage across all architectural invariants).
